...
train_paths,train_L = read_image_paths('nuswide10/train.txt')
test_paths,test_L = read_image_paths('nuswide10/test.txt')
database_paths,database_L = read_image_paths('nuswide10/database.txt')
...
torch.save(cnn.state_dict(), 'nuswide10.pkl')
