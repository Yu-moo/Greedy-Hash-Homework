...
def read_image_paths(filename):
    ...
    full_path=[f'/root/autodl-tmp/mirflickr25k/mirflickr/{path}' for path in paths]
    return full_path,np.array(labels_list)

train_paths,train_L = read_image_paths('mirflickr/train.txt')
test_paths,test_L = read_image_paths('mirflickr/test.txt')
database_paths,database_L = read_image_paths('mirflickr/database.txt')
...
torch.save(cnn.state_dict(), 'flickr25k.pkl')
